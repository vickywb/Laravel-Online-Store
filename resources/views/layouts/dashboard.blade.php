...
<head>
    ...
    <title>{{ isset($headerTitle) ? $headerTitle . '-' : '' }}User Dashboard</title>
        ...
        <div class="d-flex" id="wrapper" data-aos="fade-right">
            ...
            <div class="border-right" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a href="{{ route('dashboard-store-settings') }}"
                        class="list-group-item list-group-item-action {{ (request()->is('dashboard-store-settings')) ? 'active' : '' }}">Store
                        Settings</a>
                    <a href="{{ route('dashboard-account-settings') }}"
                        class="list-group-item list-group-item-action {{ (request()->is('dashboard-account-settings')) ? 'active' : '' }}">My
                        Account</a>
                </div>
            </div>
            <!-- /#sidebar-wrapper -->
                        ...
                        <ul class="navbar-nav ml-auto d-none d-lg-flex">
                            <li class="nav-item dropdown">
                                <a class="nav-link" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
                                    ...
                                    <img src="{{ Auth::user()->profile->fileUrl ?? asset('img/blank.png') }}" alt=""
                                        class="rounded-circle mr-2 profile-picture" />
                                    Hi, {{ Auth::user()->name }}
                                </a>
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('home') }}">Back to Store</a>
                                    <a class="dropdown-item" href="{{ route('dashboard-account-settings') }}">Settings</a>
